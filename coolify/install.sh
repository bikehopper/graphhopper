...
npx @bikehopper/node-tippecanoe -zg -Z8 -l ways_dump -P -o web-bundle/src/main/resources/com/graphhopper/maps/debug/ways.pmtiles --drop-densest-as-needed logs/ways_dump.ldgeojson
