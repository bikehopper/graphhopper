...
npx @bikehopper/node-tippecanoe -z14 -Z8 --maximum-tile-bytes=1572864 -l ways_dump -P -o web-bundle/src/main/resources/debug/ways.pmtiles --drop-densest-as-needed /tmp/graphhopper/ways_dump.ldgeojson
