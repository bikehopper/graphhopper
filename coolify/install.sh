...
npx @bikehopper/node-tippecanoe -zg -Z8 -l ways_dump -P -o web-bundle/src/main/resources/debug/ways.pmtiles --drop-densest-as-needed /tmp/graphhopper/ways_dump.ldgeojson
